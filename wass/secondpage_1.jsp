...
<%
	...
	{
		 third_1_1 = wassEntryStructs.getThird_1_1();
		 third_1_1_elements = wassEntryStructs.getThird_1_1_elements();
		
		 third_1_2 = wassEntryStructs.getThird_1_2();
		 third_1_2_elements = wassEntryStructs.getThird_1_2_elements();
