...
<%
	...
	EntryStruct third_2_1 = null;
	List<EntryStruct> third_2_1_elements = null;
	
	EntryStruct third_2_2 = null;
	List<EntryStruct> third_2_2_elements = null;
	
	EntryStruct third_2_3 = null;
	List<EntryStruct> third_2_3_elements = null;
	
	EntryStruct third_2_4 = null;
	List<EntryStruct> third_2_4_elements = null;
	
	
	WASSEntryStructElement wassEntryStructs = (WASSEntryStructElement)request.getAttribute("wassEntryStructs");
	...
	if(wassEntryStructs != null)
	{
	
		 third_2_1 = wassEntryStructs.getThird_2_1();
		 third_2_1_elements = wassEntryStructs.getThird_2_1_elements();
		
		 third_2_2 = wassEntryStructs.getThird_2_2();
		 third_2_2_elements = wassEntryStructs.getThird_2_2_elements();
		
		third_2_3 = wassEntryStructs.getThird_2_3();
		 third_2_3_elements = wassEntryStructs.getThird_2_3_elements();
		
		third_2_4 = wassEntryStructs.getThird_2_4();
		 third_2_4_elements = wassEntryStructs.getThird_2_4_elements();
...
function callbackFunVideoType1(data)
{
	...
	alert(result);
	document.getElementById("dzbl").href=data.pageurl;
						...
						<td height="24" bgcolor="#353c44"><table width="100%"
								...
								<tr>
									...
									<td><div align="right">
											...
											<img src="../images/prtj.jpg" align="middle" alt="添加" border="0"/></a>
											
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<a href="javascript:alert('未生成电子病历')" target=”_blank” id="dzbl">
											<img src="../images/dzbl.jpg" align="middle" alt="电子病历" border="0"/></a>
...
<div id="tabs">
	<ul>
		<li><a href="#tabs-1">一般护理</a></li>
		<li><a href="#tabs-2">临症施护</a></li>
		<li><a href="#tabs-3">膳食调护</a></li>
		<li><a href="#tabs-4">健康指导</a></li>
	</ul>
	...
	<div id="tabs-1">
		<div class="box">
				...
				<%
					for (EntryStruct node : third_2_1_elements) {
						%>
	...
	<div id="tabs-2">
		<div class="box">
				...
				<%
					for (EntryStruct node : third_2_2_elements) {
						%>
			<input type='checkbox' name='checkboxall' value='<%=node.getRandkey()%>' /> <%=node.getName()%>
	...
	<div id="tabs-3">
		<div class="box">
			...
			<%
					for (EntryStruct node : third_2_3_elements) {
						%>
							<input type='checkbox' name='checkboxall' value='<%=node.getRandkey()%>' /> <%=node.getName()%>
	...
	<div id="tabs-4">
			...
			<%
					for (EntryStruct node : third_2_4_elements) {
						%>
							<input type='checkbox' name='checkboxall' value='<%=node.getRandkey()%>' /> <%=node.getName()%>
