...
<body>
	...
	<table width="100%" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td height="600" valign="top">
				<form action="VerifyPatient.action" method="post"  id="VerifyPatientForm"> 
	...
	<tr>
		<td align="center" colspan="2">
			...
			<a href="GetJCYStruct.action?firstNodeNum=1&secondNodeNum=2&patientId=<%=patientId%>" >大肠湿热证</a> &nbsp;
			</div>
		</td>
		<td align="center" colspan="2">
			<div align="center">
			...
			<a href="GetJCYStruct.action?firstNodeNum=1&secondNodeNum=3&patientId=<%=patientId%>">脾虚湿蕴证</a> &nbsp;
			</div>
		</td>
	...
	<tr>
		...
		<td align="center" colspan="2">
			<div align="center">
			<input name="submit" style="border:0px"
		 	 type="image" onclick="getentryinfo('130')" src="../images/add.gif"/>
			<a href="GetJCYStruct.action?firstNodeNum=1&secondNodeNum=4&patientId=<%=patientId%>">寒热错杂证</a> &nbsp;
			</div>
		</td>
		<td align="center" colspan="2">
			<div align="center">
			<input name="submit" style="border:0px"
		 	 type="image" onclick="getentryinfo('140')" src="../images/add.gif"/>
			<a href="GetJCYStruct.action?firstNodeNum=1&secondNodeNum=5&patientId=<%=patientId%>">肝郁脾虚证</a> &nbsp;
			</div>
		</td>
	...
	<tr>
		<td align="center" colspan="2">
			<div align="center">
			<input name="submit" style="border:0px"
		 	 type="image" onclick="getentryinfo('150')" src="../images/add.gif"/>
			<a href="GetJCYStruct.action?firstNodeNum=1&secondNodeNum=6&patientId=<%=patientId%>">脾肾阳虚证</a> &nbsp;
			</div>
		</td>
		<td align="center" colspan="2">
			<div align="center">
			<input name="submit" style="border:0px"
		 	 type="image" onclick="getentryinfo('160')" src="../images/add.gif"/>
			<a href="GetJCYStruct.action?firstNodeNum=1&secondNodeNum=7&patientId=<%=patientId%>">阴血亏虚证</a> &nbsp;
			</div>
