...
<body>
	...
	<table width="100%" border="0" align="center" cellpadding="0"
		...
		<tr>
			...
			<form action="VerifyPatientWAHL.action" method="post"  id="VerifyPatientForm"> 	
	...
	<tr>
		<td align="center" colspan="2">
			...
			<input name="submit" style="border:0px"
		 	 type="image" onclick="getentryinfo('210')" src="../images/add.gif"/>
	

			<a href="GetWAHLStruct.action?firstNodeNum=191&secondNodeNum=192&patientId=<%=patientId%>">脾胃虚弱证</a> &nbsp;
			</div>
		</td>
		<td align="center" colspan="2">
			<div align="center">
			<input name="submit" style="border:0px"
		 	 type="image" onclick="getentryinfo('220')" src="../images/add.gif"/>
			<a href="GetWAHLStruct.action?firstNodeNum=191&secondNodeNum=193&patientId=<%=patientId%>">脾胃虚寒证</a> &nbsp;
			</div>
		</td>
	...
	<tr>
		...
		<td align="center" colspan="2">
			<div align="center">
			<input name="submit" style="border:0px"
		 	 type="image" onclick="getentryinfo('230')" src="../images/add.gif"/>
			<a href="GetWAHLStruct.action?firstNodeNum=191&secondNodeNum=194&patientId=<%=patientId%>">胃热伤阴证</a> &nbsp;
			</div>
		</td>
		<td align="center" colspan="2">
			<div align="center">
			<input name="submit" style="border:0px"
		 	 type="image" onclick="getentryinfo('240')" src="../images/add.gif"/>
			<a href="GetWAHLStruct.action?firstNodeNum=191&secondNodeNum=195&patientId=<%=patientId%>">肝胃不和证</a> &nbsp;
			</div>
		</td>
	...
	<tr>
		<td align="center" colspan="2">
			<div align="center">
			<input name="submit" style="border:0px"
		 	 type="image" onclick="getentryinfo('250')" src="../images/add.gif"/>
			<a href="GetWAHLStruct.action?firstNodeNum=191&secondNodeNum=196&patientId=<%=patientId%>">气滞血瘀证</a> &nbsp;
			</div>
		</td>
		<td align="center" colspan="2">
			<div align="center">
			<input name="submit" style="border:0px"
		 	 type="image" onclick="getentryinfo('260')" src="../images/add.gif"/>
			<a href="GetWAHLStruct.action?firstNodeNum=191&secondNodeNum=197&patientId=<%=patientId%>">气血亏虚证</a> &nbsp;
			</div>
		</td>
	...
	<tr>
		<td align="center" colspan="2">
			<div align="center">
			<input name="submit" style="border:0px"
		 	 type="image" onclick="getentryinfo('270')" src="../images/add.gif"/>
			<a href="GetWAHLStruct.action?firstNodeNum=191&secondNodeNum=198&patientId=<%=patientId%>">痰湿凝结证</a> &nbsp;
			</div>
		</td>
		<td align="center" colspan="2">
			<div align="center">
