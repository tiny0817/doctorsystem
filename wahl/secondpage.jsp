...
<%
	...
	EntryStruct third_1_3 = null;
	List<EntryStruct> third_1_3_elements = null;
	...
	WAHLEntryStructElement wahlEntryStructs = (WAHLEntryStructElement)request.getAttribute("wahlEntryStructs");
	...
	if(wahlEntryStructs != null)
	{
	
		 third_0 = wahlEntryStructs.getThird_0();
		
		 third_1 = wahlEntryStructs.getThird_1();
		 third_1_1 = wahlEntryStructs.getThird_1_1();
		 third_1_1_elements = wahlEntryStructs.getThird_1_1_elements();
		
		 third_1_2 = wahlEntryStructs.getThird_1_2();
		 third_1_2_elements = wahlEntryStructs.getThird_1_2_elements();
		 
		 third_1_3 = wahlEntryStructs.getThird_1_3();
		 third_1_3_elements = wahlEntryStructs.getThird_1_3_elements();
		
		 third_2 = wahlEntryStructs.getThird_2();
		 third_2_elements = wahlEntryStructs.getThird_2_elements();
		 third_3 = wahlEntryStructs.getThird_3();
		 third_3_elements = wahlEntryStructs.getThird_3_elements();
	}else{
	...
	<div id="tabs-1">
		<div class="box">
		 ...
		 <input name="submit" style="border:0px"
			...
			<div class="text">
				<%
					for (EntryStruct node : third_1_3_elements) {
						%>
							<input type='checkbox' name='checkboxall' value='<%=node.getRandkey()%>' /> <%=node.getName()%>
